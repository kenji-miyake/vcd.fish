...
complete -c ccd -f -n "__fish_is_first_token && __fish_not_contain_opt -s h && __fish_seen_argument -s s" -a "(__ccd_get_candidate_pkgs src)"
complete -c ccd -f -n "__fish_is_first_token && __fish_not_contain_opt -s h && __fish_seen_argument -s i" -a "(__ccd_get_candidate_pkgs install)"
